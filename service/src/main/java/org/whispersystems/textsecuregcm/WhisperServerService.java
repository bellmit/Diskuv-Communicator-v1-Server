...
public class WhisperServerService extends Application<WhisperServerConfiguration> {
      ...
      throws Exception
  {
    ...
    MessageController      messageController         = new MessageController(jwtAuthentication, rateLimiters, messageSender, receiptSender, syntheticAccountsManager, messagesManager, apnFallbackManager, dynamicConfigurationManager);
