...
public class RateLimiters {
  ...
  public RateLimiters(RateLimitsConfiguration config, DynamicConfigurationManager dynamicConfig, FaultTolerantRedisCluster cacheCluster, FaultTolerantRedisCluster newCacheCluster) {
    ...
    this.connectWebSocketLimiter = new RateLimiter(cacheCluster, newCacheCluster, "connectWebSocket",
                                              config.getConnectWebSocket().getBucketSize(),
                                              config.getConnectWebSocket().getLeakRatePerMinute());

    this.sanctuaryLookupLimiter = new RateLimiter(cacheCluster, newCacheCluster, "sanctuaryLookup",
