...
public class KeysTest {
  ...
  public void testPopulateKeys() throws SQLException {
    ...
    for (int i=1;i<=100;i++) {
      deviceOnePreKeys.add(new PreKey(i, UUID_ALICE_STRING + "Device1PublicKey" + i));
      deviceTwoPreKeys.add(new PreKey(i, UUID_ALICE_STRING + "Device2PublicKey" + i));
    }

    for (int i=1;i<=100;i++) {
      oldAnotherDeviceOnePrKeys.add(new PreKey(i, "OldPublicKey" + i));
      anotherDeviceOnePreKeys.add(new PreKey(i, UUID_BOB_STRING + "Device1PublicKey" + i));
      anotherDeviceTwoPreKeys.add(new PreKey(i, UUID_BOB_STRING + "Device2PublicKey" + i));
    }

    keys.store(UUID_ALICE_STRING, 1, deviceOnePreKeys);
    keys.store(UUID_ALICE_STRING, 2, deviceTwoPreKeys);

    keys.store(UUID_BOB_STRING, 1, oldAnotherDeviceOnePrKeys);
    keys.store(UUID_BOB_STRING, 1, anotherDeviceOnePreKeys);
    keys.store(UUID_BOB_STRING, 2, anotherDeviceTwoPreKeys);
    ...
    verifyStoredState(statement, UUID_ALICE_STRING, 1);
    verifyStoredState(statement, UUID_ALICE_STRING, 2);
    verifyStoredState(statement, UUID_BOB_STRING, 1);
    verifyStoredState(statement, UUID_BOB_STRING, 2);
  }
  ...
  public void testKeyCount() {
    ...
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(100);
  }
  ...
  public void testGetForDevice() {
    ...
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(100);
    List<KeyRecord> records = keys.get(UUID_ALICE_STRING, 1);
    ...
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(99);
    assertThat(keys.getCount(UUID_ALICE_STRING, 2)).isEqualTo(100);
    assertThat(keys.getCount(UUID_BOB_STRING, 1)).isEqualTo(100);
    assertThat(keys.getCount(UUID_BOB_STRING, 2)).isEqualTo(100);

    records = keys.get(UUID_ALICE_STRING, 1);
    ...
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(98);
    assertThat(keys.getCount(UUID_ALICE_STRING, 2)).isEqualTo(100);
    assertThat(keys.getCount(UUID_BOB_STRING, 1)).isEqualTo(100);
    assertThat(keys.getCount(UUID_BOB_STRING, 2)).isEqualTo(100);

    records = keys.get(UUID_ALICE_STRING, 2);

    assertThat(records.size()).isEqualTo(1);
    assertThat(records.get(0).getKeyId()).isEqualTo(1);
    assertThat(records.get(0).getPublicKey()).isEqualTo("+14152222222Device2PublicKey1");
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(98);
    assertThat(keys.getCount(UUID_ALICE_STRING, 2)).isEqualTo(99);
    assertThat(keys.getCount(UUID_BOB_STRING, 1)).isEqualTo(100);
    assertThat(keys.getCount(UUID_BOB_STRING, 2)).isEqualTo(100);
  }
  ...
  public void testGetForAllDevices() {
    ...
    keys.store(UUID_BOB_STRING, 1, anotherDeviceOnePreKeys);
    keys.store(UUID_BOB_STRING, 2, anotherDeviceTwoPreKeys);
    keys.store(UUID_BOB_STRING, 3, anotherDeviceThreePreKeys);


    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(100);
    assertThat(keys.getCount(UUID_ALICE_STRING, 2)).isEqualTo(100);

    List<KeyRecord> records = keys.get(UUID_ALICE_STRING);
    ...
    records = keys.get(UUID_ALICE_STRING);
    ...
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(98);
    assertThat(keys.getCount(UUID_ALICE_STRING, 2)).isEqualTo(98);


    records = keys.get(UUID_BOB_STRING);
    ...
    assertThat(keys.getCount(UUID_BOB_STRING, 1)).isEqualTo(99);
    assertThat(keys.getCount(UUID_BOB_STRING, 2)).isEqualTo(99);
    assertThat(keys.getCount(UUID_BOB_STRING, 3)).isEqualTo(99);
  }
  ...
  public void testGetForAllDevicesParallel() throws InterruptedException {
    ...
    assertThat(keys.getCount(UUID_ALICE_STRING, 1)).isEqualTo(80);
    assertThat(keys.getCount(UUID_ALICE_STRING,2)).isEqualTo(80);
  }
