...
import org.whispersystems.textsecuregcm.auth.BaseDiskuvAccountAuthenticator;
...
public class BaseAccountAuthenticatorTest {
    ...
    private BaseDiskuvAccountAuthenticator baseAccountAuthenticator;
    private com.diskuv.communicatorservice.auth.JwtAuthentication        jwtAuthentication;
    private Clock                    clock;
    ...
    public void setup() {
        ...
        jwtAuthentication          = mock(com.diskuv.communicatorservice.auth.JwtAuthentication.class);
        clock                      = mock(Clock.class);
        baseAccountAuthenticator   = new BaseDiskuvAccountAuthenticator(accountsManager, jwtAuthentication, clock);

        acct1      = new Account(AuthHelper.getRandomUUID(random), Set.of(new Device(1, null, null, null, null, null, null, null, false, 0, null, yesterday, 0, null, 0, null)), null);
        acct2      = new Account(AuthHelper.getRandomUUID(random), Set.of(new Device(1, null, null, null, null, null, null, null, false, 0, null, yesterday, 0, null, 0, null)), null);
        oldAccount = new Account(AuthHelper.getRandomUUID(random), Set.of(new Device(1, null, null, null, null, null, null, null, false, 0, null, oldTime, 0, null, 0, null)), null);
    }
