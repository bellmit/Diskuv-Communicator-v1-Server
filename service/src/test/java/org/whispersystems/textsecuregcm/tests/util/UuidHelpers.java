...
public class UuidHelpers {
    ...
    public static final UUID UUID_ALICE      = DiskuvUuidUtil.uuidForOutdoorEmailAddress(EMAIL_ALICE);
    public static final UUID UUID_BOB        = DiskuvUuidUtil.uuidForOutdoorEmailAddress(EMAIL_BOB);
    public static final UUID UUID_MISSING    = DiskuvUuidUtil.uuidForOutdoorEmailAddress(EMAIL_MISSING);
